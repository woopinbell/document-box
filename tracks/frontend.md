...
React/Next.js 구현 기본기에서 공개 납품, 실패 모드와 5-design Portfolio까지 이어지는 공식
Frontend 트랙입니다.
...
`grounded-travel`, `cloud-launch-training`과 별도 mobile 프로젝트는 이 공식 순서에 포함하지 않습니다.
...
## 3. `frontend-reliability-training`
